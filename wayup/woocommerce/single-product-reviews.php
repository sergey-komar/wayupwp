 ...
 * 
 * 
 * ОТЗЫВЫ НА СТРАНИЦЕ КАРТОЧКИ ТОВАРА ОТЗЫВЫ НА СТРАНИЦЕ КАРТОЧКИ ТОВАРА ОТЗЫВЫ НА СТРАНИЦЕ КАРТОЧКИ ТОВАРА
 */
			...
			<?php
				...
				$fields              = array(
					...
					'phone'  => array(
						...
						'type'     => 'phone',
						'value'    => $commenter['comment_author_phone'],
						'required' => $name_email_required,
					),
					'social'  => array(
						'label'    => __( 'Социальная сеть', 'woocommerce' ),
						'type'     => 'social',
						'value'    => $commenter['comment_author_social'],
						'required' => $name_email_required,
					),
				);
				...
				$comment_form['comment_field'] = '<div class="log__group log__group_textarea"><label for="comment">' . esc_html__( 'Ваш отзыв', 'woocommerce' ) . '&nbsp;<span class="required">*</span></label><textarea id="comment" name="comment" class="log__input" cols="45" rows="8" required></textarea></div> 	<p class="log__line"><span>*</span>Поля обязательные для заполнения</p>';
