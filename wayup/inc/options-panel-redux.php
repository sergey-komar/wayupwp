...
// This is your option name where all the Redux data is stored.redux_demo
$opt_name = 'wayup_option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Глобальные настройки', 'wayup' ),
		'id'               => 'globalsetings',
		'desc'             => esc_html__( 'Настройки header и footer', 'wayup' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Социальные сети', 'wayup' ),
		'id'               => 'socialprofiles',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Вставьте социальные иконки' ),
		'fields'           => array(
			array(
				'id'       => 'social_links',
				'type'     => 'sortable',
				'title'    => esc_html__( 'Социальные иконки', 'wayup' ),
				'subtitle' => esc_html__( 'Ссылки на социальные сети', 'wayup' ),
				'label'    => true,
				'options'  => array(
					'VK link'   => '',
					'FB link'   => '',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Контакты', 'wayup' ),
		'id'               => 'contacts',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Контакты в header и footer' ),
		'fields'           => array(
			...
			array(
				'id'       => 'header_phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Телефон в шапке', 'wayup' ),
				'subtitle' => esc_html__( 'Номер телефона', 'wayup' ),
				'desc'     => esc_html__( 'Вставьте телефон в шапке', 'wayup' ),
				'default'  => '+ 7 (495) 567-28-15',
			),
			...
			array(
				'id'       => 'header_address',
				'type'     => 'text',
				'title'    => esc_html__( 'Адрес в футере', 'wayup' ),
				'subtitle' => esc_html__( 'Адрес', 'wayup' ),
				'desc'     => esc_html__( 'Вставьте Адрес в футере', 'wayup' ),
				'default'  => '',
			),
			...
			array(
				'id'       => 'footer_phone',
				'type'     => 'multi_text',
				'title'    => esc_html__( 'Телефон в футере', 'wayup' ),
				'subtitle' => esc_html__( 'Номер телефона', 'wayup' ),
				'desc'     => esc_html__( 'Вставьте номер телефона в футере', 'wayup' ),
			),

			array(
				'id'       => 'header_email',
				'type'     => 'text',
				'title'    => esc_html__( 'Email в футере', 'wayup' ),
				'subtitle' => esc_html__( 'Email', 'wayup' ),
				'validate' => 'email',
				'desc'     => esc_html__( 'Вставьте Email в футере', 'wayup' ),
				'default'  => '',
			),
		)
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Главная и header', 'wayup' ),
		'id'               => 'home_header',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница-слайдер-header' ),
		'fields'           => array(
			array(
				'id'           => 'header_bg',
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Фоновая картинка', 'wayup' ),
				'compiler'     => 'true',
				'desc'         => esc_html__( 'Фоновое изображение в header рекомендованные размеры 1920 998', 'wayup' ),
				'subtitle'     => esc_html__( 'Вставьте кратинку', 'wayup' ),
				'preview_size' => 'full',
			),
			...
			array(
				'id'       => 'header_time',
				'type'     => 'text',
				'title'    => esc_html__( 'Время', 'wayup' ),
				'default'  => '',
			),
			array(
				'id'       => 'header_video',
				'type'     => 'text',
				'title'    => esc_html__( 'Видео', 'wayup' ),
				'default'  => '',
			),
			array(
				'id'       => 'header_video_title',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовок видео', 'wayup' ),
				'default'  => '',
			),

			array(
				'id'            => 'header_home_slider',
				'type'          => 'slides',
				'title'         => esc_html__( 'Слайдер на главной странице', 'wayup' ),
				'desc'          => esc_html__( 'Вставьте данные в слайдер','wayup') 
			),
		)
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Свои типы записей', 'wayup' ),
		'id'               => 'posttype',
		'desc'             => esc_html__( 'Опции для своих типов записей', 'wayup' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
	)	
);
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Отзывы', 'wayup' ),
		'id'               => 'testimonialposttype',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Данные для странице отзывы' ),
		'fields'           => array(
			array(
				'id'       => 'testilabel1',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовок', 'wayup' ),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Шорт код формы', 'wayup' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Service', 'wayup' ),
		'id'               => 'serviceposttype',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Данные для страниц service' ),
		'fields'           => array(
			array(
				'id'       => 'caselabel',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовок для слайдера', 'wayup' ),
			...
			array(
				...
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовк 1 страницы archiveservice', 'wayup' ),
				'default'  => 'Наши',
			),
			array(
				'id'       => 'servicearchivetitle2',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовк 2 страницы archiveservice', 'wayup' ),
				'default'  => 'Услуги',
			),
			array(
				'id'       => 'servicearchivedesc',
				'type'     => 'text',
				'title'    => esc_html__( 'Описание', 'wayup' ),
				'default'  => 'Вы хотите реализовать свои бизнес идеи?<br>
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Новости', 'wayup' ),
		'id'               => 'newsposttype',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Опции для страницы новости' ),
		'fields'           => array(
			array(
				'id'       => 'newstitle1',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовок первая часть', 'wayup' ),
				'default'  => 'Актуальные',
			),
			...
			array(
				'id'       => 'newstitle2',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовк вторая часть', 'wayup' ),
				'default'  => 'НОВОСТИ',
			),
